...
; * Compile this script.
;
; The resulting installer will be called "LMS Desktop Assistant Installer v#.## (portable).exe", and will be
...
AppVerName={#MyAppVerName} (portable)
...
OutputBaseFilename=LMS Desktop Assistant Installer {#MyAppVersion} (portable)
OutputDir=.\
...
[Files]
Source: LMS Desktop Assistant\LMS Desktop Assistant.exe; DestDir: {app}; Flags: ignoreversion
; settings file to make it stand-alone
Source: settings\settings.xml; DestDir: {app}; Flags: ignoreversion
Source: LMS Desktop Assistant\SgmlReaderDll.dll; DestDir: {app}; Flags: ignoreversion
Source: LMS Desktop Assistant\copying.rtf; DestDir: {app}; Flags: ignoreversion
Source: LMS Desktop Assistant\credits.txt; DestDir: {app}; Flags: ignoreversion
; change log files
...
; language files
Source: LMS Desktop Assistant\language\English.ini; DestDir: {app}\language; Flags: ignoreversion
Source: LMS Desktop Assistant\language\English_blank.dotx; DestDir: {app}\language; Attribs: readonly; Flags: ignoreversion uninsremovereadonly overwritereadonly
Source: LMS Desktop Assistant\language\English_full.dotx; DestDir: {app}\language; Attribs: readonly; Flags: ignoreversion uninsremovereadonly overwritereadonly
Source: LMS Desktop Assistant\language\Nederlands.ini; DestDir: {app}\language; Flags: ignoreversion
Source: LMS Desktop Assistant\language\Nederlands_blank.dotx; DestDir: {app}\language; Attribs: readonly; Flags: ignoreversion uninsremovereadonly overwritereadonly
Source: LMS Desktop Assistant\language\Nederlands_full.dotx; DestDir: {app}\language; Attribs: readonly; Flags: ignoreversion overwritereadonly uninsremovereadonly
...
// ********************************************************************************
// * Choose different folder for non-admin user
// * Based on code written by Kyle Alons.
// * Source: http://www.kinook.com/blog/?p=53
